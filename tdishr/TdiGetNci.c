...
STATIC_CONSTANT struct item {
  ...
  "NUMVIS_CHILDREN", 0, 0, NciNUMVIS_CHILDREN, DTYPE_L, 4}, {
  "NUMVIS_MEMBERS", 0, 0, NciNUMVIS_MEMBERS, DTYPE_L, 4}, {
  ...
  "VIS_CHILDREN", 0, NciNUMVIS_CHILDREN, NciVIS_CHILDREN, DTYPE_NID, 0}, {
  "VIS_MEMBERS", 0, NciNUMVIS_MEMBERS, NciVIS_MEMBERS, DTYPE_NID, 0}, {
