...
#define TreeBLOCKID 0x3ade68b1
  ...
  extern EXPORT int TreeSetVisibility(int nid_in, int visible, int parents, int descendants);
  extern EXPORT int _TreeSetVisibility(void *dbid, int nid_in, int visible, int parents, int descendants);
